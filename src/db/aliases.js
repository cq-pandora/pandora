...
exports.accept = (alias) => connect()
    ...
    .then(connect).then(con => con.query(GET_BY_ALIAS, alias, (err, res) => err ? console.log('Unable to apply new alias locally') : (config.aliases[alias.toLowerCase()] = res[0].for)))
    .catch(err => {
